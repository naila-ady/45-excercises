...
console.log("Testing inequality with strings:", "laptop" == "Desktop");
//2nd method
console.log("Testing equality with strings:", "Apple" === "Apple");
console.log("Testing inequality with strings:", "Apple" != "orange");
...
console.log("or operators test:", (6 === 7) || 6 > 6);
//Testing whether an item is in a array
var clothes = ["T-shirt", "Jacket", "Woodie", "Jeans"];
...
var mobile = ["I-phone", "Nokia", "Samsung", "I-tel"];
