...
var guest_list = ["Mr.kamran Tessori", "Mr.Zia khan", "Mr.Daniyal Nagori", "Mr.Faisal Mehmood"];
//removing 1st guest  
var guest_unavailable = guest_list[0];
...
guest_list.forEach(function (addedguests) { return console.log("Respescted Sir/Madam,\n".concat(addedguests, "\nIt would be honour for me to have you at a dinner.\nAwiaitng to Welcome You at\nVenue:Bellagio Restaurant\nDated:25-mar-24\nThankyou\n")); });
...
while (guest_list.length > 2) {
    ...
    console.log("Sorry,".concat(removed_Guest, " for cancelling the invitation for dinner"));
}
