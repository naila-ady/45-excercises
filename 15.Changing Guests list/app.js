...
var guests_List = ["Mr.Kamran Tessori", "Mr.Zia khan", "Mr.Daniyal Nagori", "Mr.Faisal Mehmood"];
guests_List.forEach(function (guests) { return console.log("Respected Sir/Madam,\n".concat(guests, "\nIt would be honour for me to have you at a dinner.\nAwiaitng to Welcome You at\nVenue:Bellagio Restaurant\nDated:25-mar-24\nThankyou\n")); });
//code for exercise 15
//using .shift to remove a name from the start of array
console.log("Our Dear ".concat(guests_List.shift(), " is unable to come due to an urgent foreign visit."));
//using .unshift to add a name
guests_List.unshift("Miss.Hira Khan");
console.log("New Invitation For:\n" + guests_List);
// sending  new invitation
guests_List.forEach(function (new_guest) { return console.log("\nRespected Sir/Madam,\n".concat(new_guest, "\nIt would be honour for me to have you at a dinner.\nAwiaitng to Welcome You at\nVenue:Bellagio Restaurant\nDated:25-mar-24\nThankyou\n")); });
